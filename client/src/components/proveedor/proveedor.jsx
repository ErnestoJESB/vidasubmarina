...
const Proveedor = () => {
    ...
    return (
        <div>
            <div className="card_proveedor">
                <div className="card_proveedor__img">
                ...
                <div className="card_proveedor__avatar">
                ...
                <div className="card_proveedor__title">Cameron Williamson</div>
                <div className="card_proveedor__subtitle">Web Development</div>
                <div className="card_proveedor__wrapper">
                    <button className="card_proveedor__btn">Button</button>
                    <button className="card_proveedor__btn card_proveedor__btn-solid">Button</button>
                </div>
            </div>
            <Card1 />
        </div>
